...
namespace Arebis.Logging.GrayLog
{
    ...
    public class GrayLogUdpClient : GrayLogClient
    {
        ...
        public GrayLogUdpClient()
            : this(GraylogSettings.Default.GrayLogFacility, GraylogSettings.Default.GrayLogHost, GraylogSettings.Default.GrayLogUdpPort)
        { }
            ...
            : base(facility)
        {
            ...
            this.MaxPacketSize = GraylogSettings.Default.GrayLogUdpMaxPacketSize;
        }
        ...
        protected override async Task InternallySendMessageAsync(RecyclableMemoryStream messageBody)
        {
            ...
            {
                objectStream = this.Compress(messageBody, CompressionLevel.Optimal);
            }
            else
                objectStream = messageBody;
        ...
        /// <returns></returns>
        private static int PartsNeeded(long totalSize, int partSize)
        {
