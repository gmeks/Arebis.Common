...
namespace Arebis.Logging.GrayLog
{
    public interface IGrayLogClient : IDisposable
    {
        ...
        Task SendAsync(string shortMessage, string fullMessage = null, object data = null, Exception ex = null);
        ...
        Task SendAsync(Exception ex, SyslogLevel level = SyslogLevel.Error);
    }
}
